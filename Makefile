...
DEMO_FLAGS  = -DVIRT_UART16550_ADDR=$(VIRT_UART16550_ADDR)
DEMO_FLAGS += -DVIRT_UART16550_INTERRUPT=$(VIRT_UART16550_INTERRUPT)
DEMO_FLAGS += -DGUEST_MACHINE_NUMBER=$(GUEST_MACHINE_NUMBER)
ARCH_GENERIC_FLAGS += $(DEMO_FLAGS)
